...
import com.example.gpsroutefinder.databinding.SatelliteMapBinding;
...
public class SatelliteMap extends AppCompatActivity {
    ...
    SatelliteMapBinding satelliteMapBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        satelliteMapBinding = SatelliteMapBinding.inflate(getLayoutInflater());
        setContentView(satelliteMapBinding.getRoot());
